...
const linkSchema = z.object({
  ...
  uri: z.string().url("Please enter a valid URL").optional().or(z.literal("")),
  is_hidden: z.boolean(),
});
...
export default function ProfileLinksPage() {
  ...
  const handleDelete = async (linkId: string) => {
    if (!confirm(t("Profile", "Are you sure you want to delete this link?") || "Are you sure you want to delete this link?")) {
      return;
    }
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          {t("Profile", "Manage your social media links and external websites.") || "Manage your social media links and external websites."}
        </p>
      </div>
        ...
        <CardHeader>
          <div className={styles.cardHeaderWithAction}>
            <div>
              ...
              <CardDescription>
                {t("Profile", "Your existing social media links and websites.") || "Your existing social media links and websites."}
              </CardDescription>
            </div>
      ...
      {showForm && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {t("Profile", "Configure your social media link or website.") || "Configure your social media link or website."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t("Profile", "Choose the type of link you're adding.") || "Choose the type of link you're adding."}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        {t("Profile", "The full URL to your profile or website.") || "The full URL to your profile or website."}
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem className={styles.checkboxItem}>
                      <div className={styles.checkboxWrapper}>
                        ...
                        <div className={styles.checkboxLabel}>
                          ...
                          <FormDescription>
                            {t("Profile", "Hide this link from your public profile.") || "Hide this link from your public profile."}
                          </FormDescription>
                        </div>
                      </div>
                      <FormMessage />
