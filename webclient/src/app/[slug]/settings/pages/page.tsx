...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@/shared/components/ui/alert-dialog.tsx";
...
export default function ProfilePagesPage() {
  ...
  const loadPages = async () => {
    ...
    try {
      ...
      const response = await backend.listProfilePages(locale, profileSlug);
      if (response?.data) {
  ...
  const handleCreatePage = async () => {
    ...
    try {
      ...
      await backend.createProfilePage(locale, profileSlug, {
  ...
  const handleDeletePage = async (pageId: string) => {
    try {
      await backend.deleteProfilePage(locale, profileSlug, pageId);
      await loadPages();
    } catch (err) {
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.description}>
          {t("Profile", "Create and manage custom content pages for your profile.") || "Create and manage custom content pages for your profile."}
        </p>
      </div>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className={styles.dialog}>
            <DialogHeader>
              ...
              <DialogDescription>
                {t("Profile", "Create a new custom page for your profile with rich content.") || "Create a new custom page for your profile with rich content."}
              </DialogDescription>
            </DialogHeader>
            <div className={styles.form}>
              ...
              <div className={styles.field}>
                ...
                <Textarea
                  ...
                  placeholder={t("Profile", "Write your content here (supports Markdown)...") || "Write your content here (supports Markdown)..."}
                  className={styles.textarea}
                  rows={8}
                />
              </div>
            ...
            <DialogFooter>
              ...
              >
                {isSubmitting ? (t("Profile", "Creating...") || "Creating...") : (t("Profile", "Create Page") || "Create Page")}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
          ...
          <Card className={styles.emptyState}>
            <CardContent className={styles.emptyContent}>
              ...
              <p className={styles.emptyDescription}>
                {t("Profile", "Create your first custom page to showcase additional content.") || "Create your first custom page to showcase additional content."}
              </p>
            </CardContent>
          </Card>
        ) : (
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            {t("Profile", "Are you sure you want to delete this page? This action cannot be undone.") || "Are you sure you want to delete this page? This action cannot be undone."}
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                          <AlertDialogCancel>
